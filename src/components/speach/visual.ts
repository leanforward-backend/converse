...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  `;
    ...
    // FIX: LitElement lifecycle methods must be protected to override the base class.
    ...
    // FIX: LitElement's render method must be protected or public to override the base class method.
    protected render() {
